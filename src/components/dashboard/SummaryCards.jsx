...
export default function SummaryCards({ total, concluidos, reprovados, pendentes, vencendo, vencidos, onFilter }) {
  const cards = [
    { label: 'Total', value: total, icon: FileText, color: 'text-blue-500', border: 'border-blue-200', filter: null },
    { label: 'Concluídos', value: concluidos, icon: CheckCircle, color: 'text-green-500', border: 'border-green-200', filter: 'concluido' },
