...
const DEFAULT_OBJECTIVE = "O presente laudo técnico tem por objetivo, determinar o valor Ôhmico referente ao aterramento de equipamentos juntamente ao sistema de proteção contra descargas atmosféricas, conforme PPCI (projeto preventivo contra incêndio), atendendo a resolução n° 017/CAT/CCB/88 do Corpo de bombeiros da Polícia militar do Estado de Santa Catarina.";

const DEFAULT_METHODOLOGY = "A metodologia utilizada no presente laudo, se baseia em diversas medições da resistência ôhmica ao longo da malha de aterramento do prédio aos equipamentos. A medição é feita com um pulso de alta corrente, eliminando a possibilidade de erros de leitura em função da distância ou quantidades de hastes e/ou ferragens de um aterramento. Para um resultado aceitável, a medição deve estar abaixo do valor máximo de referência. De acordo com a norma NSCI/94 (Norma de Segurança contra Incêndio), o valor de resistência ôhmica do sistema de aterramento para edificações em geral não pode ser superior a 10 ohms em qualquer período do ano. Considera-se como valor de resistência ideal ou aceitável até um limite de (10 Ohms), sendo válidos somente valor igual ou abaixo deste.";

const DEFAULT_RECOMMENDATIONS = "Recomenda-se que o sistema de aterramento seja inspecionado e submetido a novas medições periodicamente, considerando alterações nas condições do solo e do ambiente operacional. Devem ser mantidos registros atualizados das medições, bem como realizadas verificações adicionais sempre que houver intervenções elétricas, reformas, substituição de equipamentos ou identificação de anomalias no funcionamento do sistema. Também é indicado assegurar a integridade mecânica dos condutores e conexões, mantendo-os protegidos contra corrosão, umidade, esforços mecânicos e possíveis afrouxamentos. Sempre que necessário, deve-se reapertar conexões, renovar pontos oxidados e revisar a continuidade elétrica do sistema. Por fim, recomenda-se que todas as intervenções futuras no aterramento sejam executadas por profissional habilitado, com emissão de ART correspondente.";
